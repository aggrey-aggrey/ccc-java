package creditcards.test.automation.cccomUI.setup;
...
import creditcards.test.automation.cccomUI.excelReader.Excel_Reader;

public class TestSetUp {
	
	
	public WebDriver driver;
	static String driverPath = "/Users/aodiyo/Documents/workspace/creditcards/cccomu/drivers/";
	Excel_Reader excel;
	...
	public String[][] getData(String excelName, String sheetName) {
		String path = System.getProperty("user.dir") + "/src/main/java/creditcards/test/automation/cccomUI/data/" + excelName;
	...
	public void getScreenShot(String name) {
		...
		try {
			String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/main/java/creditcards/test/automation/cccomUI/screenshot/";
